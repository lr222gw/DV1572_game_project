...
**/
aMesh::MeshEntry::MeshEntry(aiMesh *mesh) {
...
**/
aMesh::aMesh(const char *filename)
{
   ...
   for (int i = 0; i < scene->mNumMeshes; ++i) {
      meshEntries.push_back(new aMesh::MeshEntry(scene->mMeshes[i]));
   }
}
